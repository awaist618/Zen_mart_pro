...
class CustomerProfileScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
          ...
          return SingleChildScrollView(
            ...
            child: Column(
              children: [
                ...
                _SettingsGroup(
                  children: [
                    ...
                    _SettingsTile(
                      ...
                      title: 'Notifications',
                      subtitle: 'Alerts, Offers, Updates',
                      onTap: () {},
                    ),
                  ],
                ),
                ...
                _SectionHeader(title: 'Support & Security'),
                const SizedBox(height: 12),
                _SettingsGroup(
                  children: [
                    _SettingsTile(
      ...
      bottomNavigationBar: const CustomerBottomNav(currentIndex: 3), // Will need to update nav for profile if it's a separate tab
    );
  }
}
